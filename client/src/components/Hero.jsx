  ...
  return (
    ...
    min-h-screen'>
        <div className='text-center mb-6'>
            ...
            max-sm:text-xs test-grey-600'>Transform your content creation with our suite of premium AI tools.
        ...
        <div className='flex items-center gap-4 my-8 mx-auto text-gray-600'>
